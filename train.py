...
train_dataset_json_path = "/root/autodl-tmp/project/nougat-latex-ocr/latex_ocr_train_new.json"
...
# 设置SwanLab图像列表与输出路径
test_image_list = []
output_txt_path = os.path.join(output_dir, "predictions.txt")
...
# 停止记录
swanlab.finish()
print(f"所有预测结果已保存至：{output_txt_path}")
